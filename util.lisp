...
(defun angle->xy (angle amount)
  (let ((angle (mod angle 360)))
    (multiple-value-bind (x y) (%angle->xy (mod angle 90) amount)
      (cond
	((< angle 90) (list x y))
...
(defun reflect-axis (axis angle)
  (if (eql axis :y)
      (cond
	((< angle 90) (+ angle 270))
	((< 89 angle 180) (+ angle 90))
	((< 179 angle 270) (- angle 90))
	((< 269 angle 360) (- angle 270)))
      (cond
	((< angle 90) (+ angle 90))
	((< 89 angle 180) (- angle 90))
	((< 179 angle 270) (+ angle 90))
	((< 269 angle 360) (- angle 90)))))
